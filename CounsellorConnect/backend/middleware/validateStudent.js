...
const validateStudent = [
  ...
  body("phoneNumber")
    ...
    .isEmail()
    .withMessage("Valid Email is required")
    .matches(/^[a-zA-Z0-9._%+-]+@rvce\.edu\.in$/)
    .withMessage("Email must belong to the organization with domain 'rvce.edu.in'"),
  body("branch")
    .not()
    .isEmpty()
    .withMessage("Branch is required")
    ...
    .withMessage("Password must include at least 1 uppercase letter, 1 lowercase letter, 1 digit, and 1 special character"),
  body("number_of_backlogs")
    .optional()
    .isInt({ min: 0 })
    .withMessage("Number of Backlogs must be a non-negative integer"),
